...
<div id="main-cal" class="main-cal">
    ...
    <tbody id="weeks" class="weeks">   
        ...
        <th class="day-of-week-head">Sun</th>
        </tr>
        <tr id="week-1" class="week">
        <th class="day-of-week-head">Mon</th>
    
        </tr>
        <tr id="week-2" class="week">
        <th class="day-of-week-head">Tue</th>
           
        </tr>
        <tr id="week-3" class="week">
        <th class="day-of-week-head">Wed</th>
            
        </tr>
        <tr id="week-4" class="week">
        <th class="day-of-week-head">Thu</th>
            
        </tr>
        <tr id="week-5" class="week">
        <th class="day-of-week-head">Fri</th>
            
        </tr>
        <tr id="week-6" class="week">
        <th class="day-of-week-head">Sat</th>
...
(function () {
    ...
    for(var i=0; i<7; i++){
        ...
        for(var j=0; j<groups[i].length; j++ ){
            ...
            var parent_ele = document.getElementById(`week-${i}`);
